% =====================================================================================
%  Authorship Confounds in AI-Control Monitor Evaluation, and a Same-Generator Corpus
...
% Three lines, broken by hand at each phrase boundary; unbroken, LaTeX wraps after
% "Monitor" and strands "Evaluation," alone on line two. Wording checked against the
% body rather than chosen by ear:
...
%   "Same-Generator Corpus" - the body's own term, 26 uses (same-generator arm, pairs,
%     rows, split). The floors are deliberately NOT in the title: they are the
%     instrument, the corpus is what we built, and naming both made the title long
%     without making it clearer.
\title{Authorship Confounds in\\AI-Control Monitor Evaluation,\\and a Same-Generator Corpus}
