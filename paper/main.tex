...
(\inertSharePassing{} of those that pass the public tests) and are relabelled honest, so
most of the ``honest'' class consists of failed attacks.
...
\item \textbf{Do not define the negative class by attack failure.} Drop inert backdoors
      from both classes rather than relabelling a failed attack as honest.
