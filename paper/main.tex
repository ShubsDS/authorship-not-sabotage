...
% which is meta-science rather than an empirical venue paper. Run-in \paragraph labels follow
% Feng's Discussion, which uses short noun-phrase subheadings.
% =====================================================================================

\paragraph{Constructing stored pairs.}
One model should write both classes under one prompt framing, and one harness should verify
both. Regenerating a single side does not help: substituting the honest author left a larger
...
\paragraph{The negative class, and what to report.}
Defining the negative class through attack failure ties the label to the attacker rather than
the code, and puts a content-blind classifier above most monitors ranked on this split; dropping
the failed problems removes it, as does sampling that class independently of attack success. A
