% =====================================================================================
%  Authorship Confounds in AI-Control Monitor Evaluation: Baseline Floors and a Same-Generator Corpus
...
% Three lines, broken by hand. Unbroken, LaTeX wraps after "Monitor" and strands
% "Evaluation:" alone on line two. Breaking before "AI-Control" and at the colon
% puts each break on a phrase boundary. "Monitor Evaluation" not "Monitoring":
% the confound is in how monitors are evaluated, not in monitoring itself (see the
% first Limitations paragraph). "Baseline Floors" not "Trivial Baselines": floor is
% the body's word (36 uses), and the bag-of-words classifier is TRAINED, so calling
% it trivial oversells the asymmetry against the zero-shot monitors.
\title{Authorship Confounds in\\AI-Control Monitor Evaluation:\\Baseline Floors and a Same-Generator Corpus}
