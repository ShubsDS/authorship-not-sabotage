...
**Decided 2026-09-13:** the title is **Authorship Confounds in AI-Control Monitor Evaluation, and a Same-Generator Corpus**. The floors are the instrument and the corpus is what was built, so only the corpus is named; the Scope sentence in §1 carries the narrowing to stored pairs that the title does not.
